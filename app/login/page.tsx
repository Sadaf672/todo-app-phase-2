      ...
      <div className="bg-surface p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-200 dark:border-gray-700">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label htmlFor="password" className="block text-text-secondary font-medium">Password</label>
              <Link href="/forgot-password" className="text-sm text-primary-500 hover:text-primary-700 dark:hover:text-primary-400">
                Forgot password?
              </Link>
            </div>
            <div className="relative">
        ...
        <div className="mt-8 text-center text-text-secondary text-sm">
          <p>
            ...
            <Link href="/register" className="text-primary-500 hover:text-primary-700 dark:hover:text-primary-400 font-medium">
              Sign up
            </Link>
          </p>
        </div>
